...
public class MEM {
	...
	public static void schedule()
	{
		...
		System.out.println("\n" + firstFriday.getDayOfMonth() + " " +  firstFriday.getMonth() + ", " + firstFriday.getYear() + " (1)");
		System.out.println(secondFriday.getDayOfMonth() + " " +  secondFriday.getMonth() + ", " + secondFriday.getYear() + " (2)");
		System.out.println(thirdFriday.getDayOfMonth() + " " +  thirdFriday.getMonth() + ", " + thirdFriday.getYear() + " (3)");
		System.out.println(fourthFriday.getDayOfMonth() + " " +  fourthFriday.getMonth() + ", " + fourthFriday.getYear() + " (4)");
	}
